...
GPIO_PinConfig gpioPinConfigs[31] = {
    ...
    0, /* Pin is not available on this device */
    0, /* Pin is not available on this device */
    /* Owned by DEBUG_UART as TX */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH, /* CONFIG_GPIO_DEBUG_UART_TX */
    ...
    /* Owned by PAYLOAD_UART as RX */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_DOWN_INTERNAL, /* CONFIG_GPIO_PAYLOAD_UART_RX */
    /* Owned by PAYLOAD_UART as TX */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH, /* CONFIG_GPIO_PAYLOAD_UART_TX */
    GPIO_CFG_NO_DIR, /* DIO_14 */
    GPIO_CFG_NO_DIR, /* DIO_15 */
    /* Owned by DEBUG_UART as RX */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_DOWN_INTERNAL, /* CONFIG_GPIO_DEBUG_UART_RX */
    ...
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* RF_SW_2G4 */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* RF_SW_PA */
...
const uint_least8_t RF_SW_2G4_CONST = RF_SW_2G4;
const uint_least8_t RF_SW_PA_CONST = RF_SW_PA;
...
const uint_least8_t CONFIG_GPIO_PAYLOAD_UART_TX_CONST = CONFIG_GPIO_PAYLOAD_UART_TX;
const uint_least8_t CONFIG_GPIO_PAYLOAD_UART_RX_CONST = CONFIG_GPIO_PAYLOAD_UART_RX;
const uint_least8_t CONFIG_GPIO_DEBUG_UART_TX_CONST = CONFIG_GPIO_DEBUG_UART_TX;
const uint_least8_t CONFIG_GPIO_DEBUG_UART_RX_CONST = CONFIG_GPIO_DEBUG_UART_RX;
...
static const UART2CC26X2_HWAttrs uart2CC26X2HWAttrs[CONFIG_UART2_COUNT] = {
  {
    ...
    .intPriority        = (~0),
    .rxPin              = CONFIG_GPIO_PAYLOAD_UART_RX,
    .txPin              = CONFIG_GPIO_PAYLOAD_UART_TX,
  ...
  },
  {
    ...
    .intPriority        = (~0),
    .rxPin              = CONFIG_GPIO_DEBUG_UART_RX,
    .txPin              = CONFIG_GPIO_DEBUG_UART_TX,
    .ctsPin             = GPIO_INVALID_INDEX,
    .rtsPin             = GPIO_INVALID_INDEX,
    .flowControl        = UART2_FLOWCTRL_NONE,
...
const UART2_Config UART2_config[CONFIG_UART2_COUNT] = {
    {   /* PAYLOAD_UART */
        .object      = &uart2CC26X2Objects[PAYLOAD_UART],
        .hwAttrs     = &uart2CC26X2HWAttrs[PAYLOAD_UART]
    },
    {   /* DEBUG_UART */
        .object      = &uart2CC26X2Objects[DEBUG_UART],
        .hwAttrs     = &uart2CC26X2HWAttrs[DEBUG_UART]
    },
};

const uint_least8_t PAYLOAD_UART_CONST = PAYLOAD_UART;
const uint_least8_t DEBUG_UART_CONST = DEBUG_UART;
...
const WatchdogCC26XX_HWAttrs watchdogCC26XXHWAttrs[CONFIG_WATCHDOG_COUNT] = {
    /* CONFIG_WATCHDOG_0: period = 30000 */
    {
        .baseAddr    = WDT_BASE,
        .reloadValue = 30000
    },
