...
| 13 | LED Altimeter (YELLOW) | Solid = BMP581 initialized OK |
| 14 | LED Fault (RED) | Solid = any subsystem failed |
| 15 | Camera CS | Active LOW — deselect before SD access |
| 16 | SD Card CS | Active LOW — deselect before camera access |
| 17 | SPI0 MOSI | Shared camera + SD |
| 18 | SPI0 SCLK | Shared camera + SD |
| 19 | SPI0 MISO | Shared camera + SD |
